...
import com.fleencorp.feen.user.model.response.member.MemberInfoResponse;
import com.fleencorp.feen.user.model.response.member.MemberProfileStatusResponse;
