...
public class RemoveChatSpaceMemberResponse extends LocalizedResponse {
  ...
  public static RemoveChatSpaceMemberResponse of(final Long chatSpaceId, final Long chatSpaceMemberId, final ChatSpaceMembershipInfo membershipInfo) {
    return new RemoveChatSpaceMemberResponse(chatSpaceId, chatSpaceMemberId, membershipInfo);
  }
}
