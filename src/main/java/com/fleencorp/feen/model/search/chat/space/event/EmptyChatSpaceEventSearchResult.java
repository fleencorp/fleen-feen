...
public class EmptyChatSpaceEventSearchResult extends ChatSpaceEventSearchResult {
  ...
  public String getMessageCode() {
    return "empty.chat.space.event.search";
  }

  public static Supplier<ChatSpaceEventSearchResult> of(final SearchResultView result) {
    return () -> new EmptyChatSpaceEventSearchResult(result);
  }
}