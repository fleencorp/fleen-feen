package com.fleencorp.feen.model.search.stream.mutual;
...
public class MutualStreamAttendanceSearchResult extends LocalizedResponse {
  ...
  public static MutualStreamAttendanceSearchResult of(final SearchResultView result, final String targetMemberFullName) {
