...
public class EmptyChatSpaceMemberSearchResult extends ChatSpaceMemberSearchResult {
  ...
  public String getMessageCode() {
    return "empty.chat.space.member.search";
  }

  public static Supplier<ChatSpaceMemberSearchResult> of(final SearchResultView result) {
    return () -> new EmptyChatSpaceMemberSearchResult(result);
  }
}