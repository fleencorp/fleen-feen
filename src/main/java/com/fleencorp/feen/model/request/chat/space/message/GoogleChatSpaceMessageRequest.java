package com.fleencorp.feen.model.request.chat.space.message;
...
import static com.fleencorp.feen.constant.chat.space.event.message.CalendarEventChatMessageField.*;
