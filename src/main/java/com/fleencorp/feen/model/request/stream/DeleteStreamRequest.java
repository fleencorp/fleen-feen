...
public record DeleteStreamRequest(Calendar calendar, FleenStream stream, Oauth2Authorization oauth2Authorization, StreamType streamType) {
  ...
  public static DeleteStreamRequest of(final Calendar calendar, final FleenStream stream, final Oauth2Authorization oauth2Authorization, final StreamType streamType) {
    return new DeleteStreamRequest(calendar, stream, oauth2Authorization, streamType);
  }
}
