...
public class RescheduleLiveBroadcastRequest {
  ...
  public static RescheduleLiveBroadcastRequest of(final String accessTokenForHttpRequest, final LocalDateTime startDateTime, final LocalDateTime endDateTime, final String timezone) {
