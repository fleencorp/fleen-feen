...
public class ChatSpaceMembershipInfo {
  ...
  public static ChatSpaceMembershipInfo of(
    ...
    return new ChatSpaceMembershipInfo(requestToJoinStatusInfo, joinStatusInfo, isAMemberInfo, isAdminInfo, isLeftInfo, isRemovedInfo);
  }
  ...
  public static ChatSpaceMembershipInfo of() {
    ...
    return of(requestToJoinStatusInfo, joinStatusInfo, isAMemberInfo, isAAdminInfo, isLeftInfo, isRemovedInfo);
  }
