...
public class BookmarkServiceImpl implements BookmarkService {
  ...
  private final BookmarkExternalOperationService externalService;
  private final BookmarkRepository bookmarkRepository;
  private final BookmarkMapper bookmarkMapper;
  private final Localizer localizer;

  public BookmarkServiceImpl(
      final BookmarkExternalOperationService externalService,
  ...
  protected Integer updateBookmarkCount(final Long parentId, final Long otherId, final BookmarkParentType parentType, final BookmarkType bookmarkType) {
    ...
    return switch (parentType) {
      ...
      case POLL -> externalService.updatePollBookmarkCount(parentId, isBookmarked);
      case REVIEW -> externalService.updateReviewBookmarkCount(parentId, isBookmarked);
      case SOFT_ASK -> externalService.updateSoftAskBookmarkCount(parentId, isBookmarked);
      case SOFT_ASK_REPLY -> externalService.updateSoftAskReplyBookmarkCount(otherId, parentId, isBookmarked);
  ...
  protected Optional<Bookmark> findBookmarkByParent(final Long parentId, final Long otherId, final BookmarkParentType bookmarkParentType, final Member member) {
    ...
    return switch (bookmarkParentType) {
      ...
      case POLL -> bookmarkRepository.findByMemberAndPoll(memberId, parentId, POLL);
