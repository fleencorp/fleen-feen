...
public interface BookmarkRepository extends JpaRepository<Bookmark, Long> {
  ...
  @Query("SELECT l FROM Bookmark l WHERE l.memberId = :memberId AND l.chatSpaceId = :chatSpaceId AND l.bookmarkParentType =:parentType")
  ...
  @Query("SELECT l FROM Bookmark l WHERE l.memberId = :memberId AND l.streamId = :streamId AND l.bookmarkParentType =:parentType")
  Optional<Bookmark> findByMemberAndStream(
    @Param("memberId") Long memberId,
    @Param("streamId") Long streamId,
    @Param("parentType") BookmarkParentType bookmarkParentType);

  @Query("SELECT l FROM Bookmark l WHERE l.memberId = :memberId AND l.reviewId = :reviewId AND l.bookmarkParentType =:parentType")
  Optional<Bookmark> findByMemberAndReview(
    @Param("memberId") Long memberId,
    @Param("reviewId") Long reviewId,
    @Param("parentType") BookmarkParentType bookmarkParentType);

  @Query("SELECT l FROM Bookmark l WHERE l.memberId = :memberId AND l.softAskId = :softAskId AND l.bookmarkParentType =:parentType")
  ...
  @Query(value = """
    ...
    WHERE b.memberId = :memberId
      AND b.bookmarkParentType = :parentType
