...
public interface ChatSpaceMapper {
  ...
  ChatSpaceTotalMemberRequestToJoinInfo toChatSpaceTotalMemberRequestToJoinInfo(Integer totalMember);

  ChatSpaceTotalMemberInfo toChatSpaceTotalMemberInfo(Integer totalMember);
}
