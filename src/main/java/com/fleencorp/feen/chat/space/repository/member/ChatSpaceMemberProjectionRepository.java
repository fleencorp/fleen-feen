...
public interface ChatSpaceMemberProjectionRepository extends JpaRepository<ChatSpaceMember, Long> {
  ...
  @Query(value =
  """
    SELECT new com.fleencorp.feen.chat.space.model.projection.ChatSpaceMemberSelect(
      cs.chatSpaceId,
  ...
  @Query(value =
  """
    SELECT new com.fleencorp.feen.chat.space.model.projection.ChatSpaceRequestToJoinPendingSelect(
