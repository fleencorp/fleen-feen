...
public final class StreamQueryMapper5 implements RowMapper<StreamData> {

  private StreamQueryMapper5() {}

  public static StreamQueryMapper5 of() {
    return new StreamQueryMapper5();
  }
