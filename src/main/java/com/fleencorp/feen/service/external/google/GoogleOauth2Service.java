...
import com.fleencorp.feen.model.response.google.oauth2.CompletedOauth2AuthorizationResponse;
import com.fleencorp.feen.model.response.google.oauth2.RefreshOauth2TokenResponse;
import com.fleencorp.feen.model.response.google.oauth2.StartOauth2AuthorizationResponse;
import com.fleencorp.feen.model.response.google.oauth2.base.Oauth2AuthorizationResponse;
import com.fleencorp.feen.model.security.FleenUser;
import com.fleencorp.feen.repository.GoogleOauth2AuthorizationRepository;
...
public class GoogleOauth2Service {
  ...
  public GoogleOauth2Service(
      ...
      GoogleOauth2AuthorizationRepository googleOauth2AuthorizationRepository) {
   ...
   */
  public RefreshOauth2TokenResponse refreshUserAccessToken(String refreshToken, FleenUser fleenUser) {
    RefreshOauth2TokenResponse oauth2TokenResponse = refreshUserToken(refreshToken);
    GoogleOauth2Authorization googleOauth2Authorization = googleOauth2AuthorizationRepository
   ...
   */
  private void updateOauth2Authorization(GoogleOauth2Authorization googleOauth2Authorization, Oauth2AuthorizationResponse oauth2AuthorizationResponse) {
    if (nonNull(googleOauth2Authorization) && nonNull(oauth2AuthorizationResponse)) {
      ...
      googleOauth2Authorization.setAuthorizationScope(oauth2AuthorizationResponse.getScope());
  ...
  public RefreshOauth2TokenResponse refreshUserToken(String refreshToken) {
    GoogleTokenResponse googleTokenResponse = refreshAccessToken(refreshToken);
   ...
   *         or null if the authorization code is invalid or expired.
   */
  public CompletedOauth2AuthorizationResponse verifyAuthorizationCode(String authorizationCode) {
  ...
  public GoogleTokenResponse refreshAccessToken(String refreshToken) {
    try {
      GoogleRefreshTokenRequest refreshTokenRequest = new GoogleRefreshTokenRequest(
              getTransport(), getJsonFactory(), refreshToken,
  ...
  public GoogleAuthorizationCodeFlow.Builder getAuthorizationCodeFlowBuilder() {
    return new GoogleAuthorizationCodeFlow
            .Builder(getTransport(), getJsonFactory(), getClientSecrets(), getScopes())
