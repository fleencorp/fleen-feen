...
public class GoogleOauth2Service {
   ...
   */
  @MeasureExecutionTime
  public CompletedOauth2AuthorizationResponse verifyAuthorizationCodeAndSaveOauth2AuthorizationTokenDetails(final String authorizationCode, final FleenUser user) {
   final CompletedOauth2AuthorizationResponse oauth2AuthorizationResponse = verifyAuthorizationCode(authorizationCode);
    final GoogleOauth2Authorization googleOauth2Authorization = googleOauth2AuthorizationRepository
            ...
            .orElseGet(() -> GoogleOauth2Authorization.of(user.toMember()));
