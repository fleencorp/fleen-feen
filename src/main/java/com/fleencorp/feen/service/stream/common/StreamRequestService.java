...
import com.fleencorp.feen.model.request.stream.DeleteStreamRequest;
import com.fleencorp.feen.model.request.stream.PatchStreamRequest;
import com.fleencorp.feen.model.request.stream.RescheduleStreamRequest;
import com.fleencorp.feen.model.request.stream.UpdateStreamVisibilityRequest;

public interface StreamRequestService {

  /**
   * Creates a {@link PatchStreamRequest} using the provided details to update a stream's properties.
   *
   * <p>This method constructs a {@link PatchStreamRequest} object based on the provided stream and update
   ...
   * @return a {@link PatchStreamRequest} object containing the updated stream details
   */
  default PatchStreamRequest createPatchStreamRequest(final Calendar calendar, final FleenStream stream, final UpdateStreamDto updateStreamDto) {
   ...
   * @return a {@link PatchStreamRequest} object containing the updated stream details
   */
  default PatchStreamRequest createPatchStreamRequest(final Oauth2Authorization oauth2Authorization, final FleenStream stream, final UpdateStreamDto updateStreamDto) {
   ...
   * Creates a {@link PatchStreamRequest} using the provided details to update a stream's properties.
   *
   * <p>This method constructs a {@link PatchStreamRequest} object based on the provided stream, calendar,
   ...
   * @return a {@link PatchStreamRequest} object containing the updated stream details
   */
  default PatchStreamRequest createPatchStreamRequest(final Calendar calendar, final FleenStream stream, final UpdateStreamDto updateStreamDto, final Oauth2Authorization oauth2Authorization) {
    return PatchStreamRequest.of(
      calendar,
      stream,
  ...
  /**
   * Creates a {@link RescheduleStreamRequest} to reschedule a stream based on the provided details.
   *
   * <p>This method constructs a {@link RescheduleStreamRequest} object using the provided {@link Calendar},
   ...
   * @return a {@link RescheduleStreamRequest} object with the updated scheduling information
   */
  default RescheduleStreamRequest createRescheduleStreamRequest(final Calendar calendar, final FleenStream stream, final RescheduleStreamDto rescheduleStreamDto) {
    return createRescheduleStreamRequest(calendar, stream, rescheduleStreamDto, null);
  }

  /**
   * Creates a {@link RescheduleStreamRequest} to reschedule a stream with OAuth2 authorization details.
   *
   * <p>This method constructs a {@link RescheduleStreamRequest} object using the provided {@link Oauth2Authorization},
   ...
   * @return a {@link RescheduleStreamRequest} object with the updated scheduling information
   */
  default RescheduleStreamRequest createRescheduleStreamRequest(final Oauth2Authorization oauth2Authorization, final FleenStream stream, final RescheduleStreamDto rescheduleStreamDto) {
   ...
   *
   * <p>This method builds a {@link RescheduleStreamRequest} based on the stream to be rescheduled, including
   ...
   * @return a {@link RescheduleStreamRequest} containing all the information needed to reschedule the stream
   */
  default RescheduleStreamRequest createRescheduleStreamRequest(final Calendar calendar, final FleenStream stream, final RescheduleStreamDto rescheduleStreamDto, final Oauth2Authorization oauth2Authorization) {
    return RescheduleStreamRequest.of(
      calendar,
      stream,
   ...
   *
   * <p>This method prepares a {@link DeleteStreamRequest} for deleting a stream using the provided {@link FleenStream}
   ...
   *
   * @return a {@link DeleteStreamRequest} containing the necessary details to delete the stream
   */
  default DeleteStreamRequest createDeleteStreamRequest(final FleenStream stream, final Calendar calendar) {
   ...
   * @return a {@link DeleteStreamRequest} containing the necessary details to delete the stream
   */
  default DeleteStreamRequest createDeleteStreamRequest(final FleenStream stream, final Oauth2Authorization oauth2Authorization) {
   ...
   * @return a {@link DeleteStreamRequest} containing the necessary details to delete the stream
   */
  default DeleteStreamRequest createDeleteStreamRequest(final FleenStream stream, final Calendar calendar, final Oauth2Authorization oauth2Authorization) {
    return DeleteStreamRequest.of(
      calendar,
      stream,
      oauth2Authorization,
      stream.getStreamType()
  ...
  /**
   * Creates a new {@link UpdateStreamVisibilityRequest} using the provided parameters,
   ...
   * @return A new {@link UpdateStreamVisibilityRequest} object initialized with the provided parameters
   *         and a {@code null} Oauth2Authorization.
   */
  default UpdateStreamVisibilityRequest createUpdateStreamVisibilityRequest(final Calendar calendar, final FleenStream stream, final String visibility) {
   ...
   * @param stream The {@link FleenStream} object whose visibility is being updated.
   * @param visibility The desired visibility value for the stream.
   * @return A new {@link UpdateStreamVisibilityRequest} object initialized with the provided parameters and a {@code null} calendar.
   */
  default UpdateStreamVisibilityRequest createUpdateStreamVisibilityRequest(final Oauth2Authorization oauth2Authorization, final FleenStream stream, final String visibility) {
   ...
   * @return A new {@link UpdateStreamVisibilityRequest} object initialized with the provided parameters.
   */
  default UpdateStreamVisibilityRequest createUpdateStreamVisibilityRequest(final Calendar calendar, final FleenStream stream, final Oauth2Authorization oauth2Authorization, final String visibility) {
    return UpdateStreamVisibilityRequest.of(
      calendar,
      stream,
      oauth2Authorization,
      visibility,
