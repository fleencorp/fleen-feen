package com.fleencorp.feen.service.impl.external.slack;
...
public class SlackReporter implements ReporterService {
  ...
  public void sendMessage(final String message, final ReportMessageType reportMessageType) {
    ...
    log.info("Details are {} and {}", channelId, slackColor);
  ...
  protected String getChannelId(final ReportMessageType reportMessageType) {
    ...
    return switch (reportMessageType) {
      ...
      case SPOTIFY_OAUTH2 -> slackProperties.getChannelSpotifyReportId();
  ...
  protected SlackColor getColor(final ReportMessageType reportMessageType) {
    ...
    return switch (reportMessageType) {
      ...
      case GENERAL, GOOGLE_CALENDAR, GOOGLE_CHAT, GOOGLE_OAUTH2, PROFILE_VERIFICATION, SPOTIFY_OAUTH2, YOUTUBE -> SlackColor.BLUE;
    };
  }
